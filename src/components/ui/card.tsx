...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl border border-card-border bg-card text-card-foreground shadow-subtle transition-smooth hover:shadow-soft hover:border-border-subtle hover-lift backdrop-blur-sm",
      className
    )}
    {...props}
  />
